...
<body class="pageTop">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <h3>コンセプト</h3>
                <p>どんな靴をお探しですか？<br>ひとそれぞれ好みや条件に違いがあるのでぴったりくる靴を探すのは大変です。<br>デザインはいいけどサイズが合わない、サイズはいいけど素材が気に入らない…<br>仕方なく買った靴はやはりしっくりこないかもしれません</p>
                <p>クレセントシューズでは1足１足時間をかけて厳選したデザイン性とクオリティの高いオリジナル商品や手入れをしながら長くご愛用いただける商品を扱っております。<br>履くたびに足になじむ履き心地のよい靴を心をこめてお送りいたします。</p>
            </div>
            <div class="col-md-6">
                <h3>取り扱いブランド</h3>
                <ul class="list-group">
