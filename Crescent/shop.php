...
<head>
    ...
    <title>Online Shop | Crescent Shoes</title>
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                <a href="detail.php">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h2 class="h4">CE59612 ESPP-HB BR<br>
            ...
            <div class="col-md-4 text-center">
                <a href="detail02.php">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h2 class="h4">MO45689 YEVQ-YR<br>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h2 class="h4">MO47698 UPQE-UU<br>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h2 class="h4">MO45932 UPQW-VV<br>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h2 class="h4">CE65987 YEVW-UE<br>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h2 class="h4">CE95135 ESPP-HT<br>
